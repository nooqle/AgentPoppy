# Agent Jola for OpenClaw

OpenClaw should treat Agent Jola as a local game runtime plus a hosted profile/key layer.

## Agent Instruction

```text
Set up Agent Jola for me.

Rules:
1. Use https://github.com/nooqle/agent-jola.git as the canonical repo.
